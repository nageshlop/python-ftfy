...
codec still enforces the rule that characters must appear in their shortest
form. There is one exception: the sequence of bytes `0xc0 0x80`, instead of
just `0x00`, may be used to encode the null character `U+0000`, like in Java.
...
decode the bytes, then encode them, then decode them again.
"""
